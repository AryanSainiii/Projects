...
<button class="button all active" data-animated='fadeInUp'>All Products</button>
</li>
						<?php 
					foreach($products as $row)
				{ ?>
                		<li>
							<button class="button <?php echo $row["id"]?>" data-animated='fadeInUp'><?php echo $row["product_name"]?></button>
						</li>
            ...
            <div class="tab-content">
            	<div class="tab-container">
            		<div id="tab-1" class="tab-panel active">
            			<ul class="nav-style7" data-nav="true" data-autoplay="false" data-dots="false" data-loop="true" data-margin="30" data-responsive='{"0":{"items":1},"600":{"items":2},"1000":{"items":4}}'>
							<?php foreach($products as $row)
							{?>
							<div class="col-md-4">
            				<li class="product-item <?php echo $row["id"]?>">
...
products.forEach(function(elements)
{
	...
	$('.'+elements.id).click( function() {
  checkClass();
  $('.product-item:not(.'+elements.id+')').toggleClass('hide');
});
})
